# Contributing to Base Context

Thanks for your interest in contributing to Base Context! Base Context is developed in public, and we welcome bug reports, feature requests, questions, and other feedback. To keep the project maintainable, public contributions begin in [GitHub Discussions](https://github.com/BaseModelAI/base-context/discussions).
...
- [General discussion or question](https://github.com/BaseModelAI/base-context/discussions/categories/general)
- [Bug report](https://github.com/BaseModelAI/base-context/discussions/categories/bug-reports)
- [Feature request](https://github.com/BaseModelAI/base-context/discussions/categories/feature-requests)
