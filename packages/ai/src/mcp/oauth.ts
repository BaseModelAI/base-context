...
const CALLBACK_HOST = process.env.BASE_CONTEXT_OAUTH_CALLBACK_HOST || "127.0.0.1";
...
const CALLBACK_PORT_BASE = Number(process.env.BASE_CONTEXT_MCP_OAUTH_CALLBACK_PORT || 53700);
