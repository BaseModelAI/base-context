...
```bash
npm install @ponythewhite/base-context-ai
```

TypeBox exports are re-exported from `@ponythewhite/base-context-ai`: `Type`, `Static`, and `TSchema`.

## Quick Start

```typescript
import { Type, getModel, stream, complete, Context, Tool, StringEnum } from '@ponythewhite/base-context-ai';
...
```typescript
import { Type, Tool, StringEnum } from '@ponythewhite/base-context-ai';
...
```typescript
import { stream, validateToolCall, Tool } from '@ponythewhite/base-context-ai';
...
```typescript
import { getModel, streamSimple, completeSimple } from '@ponythewhite/base-context-ai';
...
```typescript
import { getModel, stream } from '@ponythewhite/base-context-ai';
...
```typescript
import { getProviders, getModels, getModel } from '@ponythewhite/base-context-ai';
...
```typescript
import { Model, stream } from '@ponythewhite/base-context-ai';
...
```typescript
import { streamAnthropic, type AnthropicOptions } from '@ponythewhite/base-context-ai';
...
```typescript
import { getModel, complete, Context } from '@ponythewhite/base-context-ai';
...
```typescript
import { Context, getModel, complete } from '@ponythewhite/base-context-ai';
...
```typescript
import { getEnvApiKey } from '@ponythewhite/base-context-ai';
...
- Add any root-level `export type` re-exports in `src/index.ts` that should remain available from `@ponythewhite/base-context-ai`
