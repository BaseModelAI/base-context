...
## Installation and source setup

Install the SDK with `npm install @ponythewhite/base-context`, or follow [installation](installation.md#source-installation) to build the workspace from source. The CLI and SDK use the same Node requirements.
...
Install any package that your application imports directly, or run inside the built workspace. Provider examples require your own supported model and credentials; they do not establish availability or entitlement.
