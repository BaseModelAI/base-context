...
> **Setup:** Follow [installation](installation.md) to install the CLI or build from source. Installing a third-party resource package is separate from installing Base Context. Review executable resources before loading them.
