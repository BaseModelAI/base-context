> Base Context can create prompt templates. Ask it to build one for your workflow.
...
Base Context loads prompt templates from:

- Global: `~/.base-context/prompts/*.md`
- Project: `.base-context/prompts/*.md`
