...
> **Setup:** Install `@ponythewhite/base-context` or follow the [source installation](installation.md). For source builds, substitute the documented Node invocation for `base-context`. Extension imports use the Base Context packages, not the upstream Pi package names.
