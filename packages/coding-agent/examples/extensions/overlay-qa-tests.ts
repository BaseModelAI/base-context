...
import type { ExtensionAPI, ExtensionCommandContext, Theme } from "@ponythewhite/base-context";
import type { Component, OverlayAnchor, OverlayHandle, OverlayOptions, TUI } from "@ponythewhite/base-context-tui";
import { matchesKey, truncateToWidth, visibleWidth } from "@ponythewhite/base-context-tui";
	...
	private startProcess(): void {
		...
		this.proc = spawn("bash", [
			...
			for i in $(seq 1 100); do
				...
				DIR="/synthetic/workspace/example-project/packages/coding-agent/src/modes/interactive"
				...
				if [ $((i % 5)) -eq 0 ]; then
					echo -e "  \\033[32m✓ Successfully processed \${i} files in /synthetic/workspace/example-project\\033[0m"
				fi
				if [ $((i % 7)) -eq 0 ]; then
