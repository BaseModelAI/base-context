...
import type { CapturedAgentResultWrite } from "./agent-results.js";
...
export interface NativeEntryWriter {
	/** Authorized host delivery archives the report without adding a model message. */
	captureAgentResult(): CapturedAgentResultWrite;
