...
export const SESSION_LEASES_ENABLED_ENV = "BASE_CONTEXT_INTERNAL_SESSION_LEASES";
export const SESSION_LEASE_OWNER_ID_ENV = "BASE_CONTEXT_INTERNAL_SESSION_LEASE_OWNER_ID";
