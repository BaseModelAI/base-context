    ...
    for month, expected_categories in expected.items():
        ...
        for category, expected_value in expected_categories.items():
            ...
            if not isinstance(value, str) or money.fullmatch(value) is None:
                return False
            if Decimal(value) != Decimal(expected_value):
                return False
    return True
    ...
    try:
        if artifact:
            ...
            if main_run.returncode != 0:
                ...
                except (OSError, UnicodeError, csv.Error, json.JSONDecodeError, ValueError, KeyError, TypeError, AttributeError) as exc:
        ...
        if artifact:
            ...
            if edge_run.returncode == 0:
                ...
                except (OSError, UnicodeError, csv.Error, json.JSONDecodeError, ValueError, KeyError, TypeError, AttributeError):
                    edge_passed = False
            else:
